...
Check the [releases](https://github.com/droboports/iftop/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/iftop.git
cd iftop
./build.sh
ls -la *.tgz
```
...
* ifstatus: http://ifstatus.sourceforge.net/
